 ...
 */
final class Version20211011093505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD est_rattaché_à_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT DEFAULT NULL, ADD campus_id INT NOT NULL, ADD lieu_id INT NOT NULL, ADD participants_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP est_rattaché_à_id');
        ...
        $this->addSql('ALTER TABLE sortie DROP etat_id, DROP campus_id, DROP lieu_id, DROP participants_id');
    }
}
